...
const MODELS = {
  ...
  "7": { name: "Liquid LFM (1.3B)", hf: "bartowski/LFM-1.3B-Instruct-GGUF:Q4_K_M", desc: "Non-transformer model (RNN-based) with high memory efficiency and long-context performance." }
};
