...
const MODELS = {
  ...
  "4": { name: "LFM 2.5 (1.2B)", hf: "bartowski/LFM-2.5-1.2B-Instruct-GGUF:Q4_K_M", desc: "Liquid architecture; elite reasoning and speed for mobile." },
  "5": { name: "Qwen 2.5 (1.5B)", hf: "bartowski/Qwen2.5-1.5B-Instruct-GGUF:Q4_K_M", desc: "Stronger reasoning and conversational performance." },
  "6": { name: "H2O Danube 3 (500M)", hf: "h2oai/h2o-danube3-500m-chat-GGUF:q4_k_m", desc: "Small chat model with excellent latency." },
